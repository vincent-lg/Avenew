...
class TestUtils(EvenniaTest):
    ...
    def test_load_YAML(self):
        ...
        self.assertEqual(document.keys()[0][0], "type")
        self.assertEqual(document.keys()[0][1], 3)
        self.assertEqual(document.keys()[1][0], "title")
        self.assertEqual(document.keys()[1][1], 4)
        self.assertEqual(document.keys()[5][0], "length")
        self.assertEqual(document.keys()[5][1], 8)
        self.assertEqual(document.keys()[6][0], "text")
        self.assertEqual(document.keys()[6][1], 9)
        self.assertEqual(document.keys()[7][0], "keep")
        self.assertEqual(document.keys()[7][1], 12)
        self.assertEqual(document.keys()[8][0], "list1")
        self.assertEqual(document.keys()[8][1], 15)
        self.assertEqual(document.keys()[9][0], "list2")
        self.assertEqual(document.keys()[9][1], 16)
        ...
        self.assertEqual(document.values()[9][2], {("field", 19): (123, 19)})
